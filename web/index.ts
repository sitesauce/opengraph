...
const themeOptions: DropdownOption[] = [
    ...
    { text: 'Brand Dark', value: 'brand_dark' },
...
const imageLightOptions: DropdownOption[] = [
	{ text: 'Sitesauce Icon', value: 'https://brand-assets.sitesauce.app/icon.svg' },
	{ text: 'Sitesauce Logo', value: 'https://brand-assets.sitesauce.app/logo-dark.svg' },
];

const imageDarkOptions: DropdownOption[] = [
	{ text: 'Sitesauce Icon', value: 'https://brand-assets.sitesauce.app/icon.svg' },
	{ text: 'Sitesauce Logo', value: 'https://brand-assets.sitesauce.app/logo-light.svg' },
];
...
const App = (_: any, state: AppState, setState: SetState) => {
    ...
    const imageOptions = ['brand', 'white'].includes(theme) ? imageLightOptions : imageDarkOptions;
            ...
            H('div',
                H(Field, {
                    ...
                    input: H(Dropdown, {
                        ...
                        value: theme,
                        onchange: (val: Theme) => {
                            const options = ['brand', 'white'].includes(val) ? imageLightOptions : imageDarkOptions
                            let clone = [...images];
